            ...
            <c:if test="${requestScope.CAR_LIST != null}">
                ...
                <table border="1">
                    ...
                    <form action="MainController" method="POST">
                            ...
                            <td>
                                <input type="text" name="carName" value="${car.getCarName()}" readonly=""/>
                            </td>
                            <td>${car.getQuantity()}</td>
                            <td>
                                <input type="number" name="price" value="${car.getPrice()}" readonly=""/>
                            </td>
                            <td>
                                <input type="number" name="sale" value="${car.getSale()}" readonly=""/>
                            </td>
