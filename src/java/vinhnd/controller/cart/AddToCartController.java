 ...
 */
package vinhnd.controller.cart;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user.getRoleID().equals("US001")) {
                ...
                CarDTO car = new CarDTO(carID, carName, quanity, price, sale, "", true);
                boolean check = cart.add(car);
                if (check) {
                    session.setAttribute("CART", cart);
                    url = SUCCESS;
                    request.setAttribute("NOTIFY", carName + "have been added to your cart");
                }
            } else {
                url = IS_ADMIN;
            }
